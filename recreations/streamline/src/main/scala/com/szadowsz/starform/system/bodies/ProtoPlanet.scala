...
/**
  ...
  */
class ProtoPlanet(star: Star, val calc: PlanetesimalCalc, var mass: Double, var axis: Double, var ecc: Double) extends Planetismal(star) {
  ...
  /**
    ...
    */
  def criticalMass: Double = calc.criticalMass(star, perihelion)
